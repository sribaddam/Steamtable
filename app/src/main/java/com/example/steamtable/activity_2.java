...
public class activity_2 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tx1.setText(String.format("%.3f",list.get(0)) + " \u2103");
        TextView tx2=findViewById(R.id.press);
        tx2.setText(String.format("%.2f",list.get(1)) +" bar");
        TextView tx3=findViewById(R.id.spec_vol);
        tx3.setText(String.format("%.2f",list.get(2)) + Html.fromHtml("m<sup>3</sup>/kg"));
        TextView tx4=findViewById(R.id.int_energy);
        tx4.setText(String.format("%.2f",list.get(3)) +" KJ/Kg");
        TextView tx5=findViewById(R.id.enthalpy);
        tx5.setText(String.format("%.2f",list.get(4)) +" KJ/Kg");
        TextView tx6=findViewById(R.id.entropy);
        tx6.setText(String.format("%.2f",list.get(5)) +" KJ/Kg-K");
